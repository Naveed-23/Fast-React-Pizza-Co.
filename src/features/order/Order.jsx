  ...
  return (
    <div className="px-4 py-6 space-y-8">
      ...
      <ul className='divide-y divide-stone-200 border-b border-t'>
        {cart.map(item => <OrderItem isLoadingIngredients={fetcher.state === 'loading'} item={item} ingredients={fetcher?.data?.find(el => el.id === item.pizzaId)?.ingredients ?? []} key={item.pizzaId}/>)}
      </ul>
