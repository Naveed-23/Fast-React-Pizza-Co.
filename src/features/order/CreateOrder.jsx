    ...
    <div className="py-6 px-4">
      ...
      <Form method="POST">
        ...
        <div className="mb-5 flex flex-col gap-2 sm:flex-row sm:items-center relative">
          ...
          { !position.latitude && !position.longitude && <span className="absolute right-[3px] top-[3px] z-50 sm:right-[5px] sm:top-[5px]">
        ...
        <div>
          ...
          <input type="hidden" name="position" value={
            position.longitude && position.latitude ? `${position.latitude}, ${position.longitude}`: ''}></input>
