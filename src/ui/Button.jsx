...
export default function Button({children, disabled, to, type, onClick}){
    ...
    const styles = {
        ...
        secondary: 'uppercase text-sm font-semibold text-stone-400 inline-block tracking-wide rounded-full hover:text-stone-800 hover:bg-stone-300 transition-colors duration-300 focus:outline-none focus:bg-stone-300 focus:ring focus:ring-stone-200 focus:text-stone-800 focus:ring-offset-2 disabled:cursor-not-allowed border-2 border-stone-300 py-2.5 px-4 md:px-6 md:py-3.5',
    }
